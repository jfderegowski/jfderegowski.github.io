    ...
    class Sticky_Floating_Forms_Lite {
        ...
        */
        ...
        public function plugin_pro_link_action( $links ) {
            ...
            $links[] = '<a href="https://codeworkweb.com/wordpress-plugins/sticky-floating-forms/" target="_blank" style="color:#05c305; font-weight:bold;">'.esc_html__('Go Pro','sticky-floating-forms-lite').'</a>';
            return $links;
        }
